...
public class Textura {
	...
	public Textura(GL10 gl, Context contexto, String nombreDeArchivo) {
		...
		leeTextura(gl);
		/* Por omisión */
		setCoord_Textura(0, 0, 2, 2);	// aqui cambiar las repeticiones
		/* Lee los indices */
	...
	public void setCoord_Textura(float u1, float v1, float u2, float v2) {
		...
		bufTextura.put(coord_textura).position(0); // puntero al principio del
													// buffer
	}
	...
	public void leeTextura(GL10 gl) {
		try {
			...
			gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_T,
					GL10.GL_REPEAT);
			/*
			 * Para limitar la textura tanto de s y t dentro del rango del 0 al
			 * 1
			 */
			// gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_S,
