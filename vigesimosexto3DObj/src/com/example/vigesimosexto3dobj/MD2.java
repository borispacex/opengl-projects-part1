...
public class MD2 {
	...
	class EncabezadoDeArchivo {
		...
		public int version;				// versión md2. es igual a 8
		...
		public int numTexturas;			// número de texturas
		public int numVertices;			// número de vértices
		public int numCoordTextura;		// número de coordenadas de textura
		public int numTriangulos;		// número de triángulos
		public int numComandosDeGL;		// número de comandos del opengl
		public int numCuadros;			// número total de cuadros
		...
		public int desplTriangulos;		// desplazamiento de los triángulos
	...
	public void animacion(String nombre) {
		/*
		 * Los nombres de los cuadros normalmente comienzan con el nombre de la animación
		 * en la que se encuentran, por ejemplo "run", y estan seguidos por un carácter no
		 * alfabético "_" y el número del cuadro. Normalmente, indican el número de
		 * cuadro en la animación, por ejemplo "run_1", "run_2", etc.
		 */
		int n = 0;
	...
	public void dibuja(GL10 gl) {
		...
		// Calcula los dos cuadros entre los que se está interpolando
		...
		// Calcula la fracción entre los dos cuadros
		float frac =
			(tiempo - (float)(iCuadro1 - cuadroInicial) /
			 (float)(cuadroFinal - cuadroInicial + 1)) * (cuadroFinal - cuadroInicial + 1);
		

		// Dibuja el modelo como una interpolación entre dos cuadros
