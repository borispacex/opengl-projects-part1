...
public class Textura {
	...
	private FloatBuffer bufCoordTextura;
	...
	public void setCoord_Textura(float u1, float v1, float u2, float v2) {
		...
		bufByte.order(ByteOrder.nativeOrder()); // Utiliza el orden de byte
												// nativo
		bufCoordTextura = bufByte.asFloatBuffer(); // Convierte de byte a float
		bufCoordTextura.put(coord_textura).position(0); // puntero al principio
														// del buffer
	}
	...
	public void muestra(GL10 gl) {
		...
		/* Se activa el arreglo de las coordenadas de textura */
		gl.glEnableClientState(GL10.GL_TEXTURE_COORD_ARRAY);
		/* Se especifica los datos del arreglo de vértices */
		gl.glVertexPointer(2, GL10.GL_FLOAT, 0, bufVertices);
		/* Se especifica los datos del arreglo de las coordenadas de textura */
		gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, bufCoordTextura);
		/*
		...
		/* Se desactiva el arreglo de las coordenadas de textura */
	...
	public void leeTextura(GL10 gl) {
		try {
			...
			gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_T,
					GL10.GL_REPEAT);
			/*
			 * Para no repetir la textura tanto de s y t dentro del rango del 0
			 * al 1
			 */
			// gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_S,
